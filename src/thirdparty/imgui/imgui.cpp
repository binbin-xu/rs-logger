...
void ImGui::plotMultiEx(ImGuiPlotType plotType, const char* label, int numDatas, const char** names, const ImColor* colors, float(*getter)(void* data, int idx), void** datas, int count, float scaleMin, float scaleMax, ImVec2 graphSize) {;
...
//            ImGui::TextColored(colors[dataIdx], fmt::format("{:4}, {:7.2f}, {}", v_idx, v0, names[dataIdx]).c_str());
        }
        ImGui::EndTooltip();
    ...
    for (int dataIdx = 0; dataIdx < numDatas; ++dataIdx)
    {
        ...
        const ImU32 col_hovered = colors[dataIdx];
...
void ImGui::plotMultiLines(const char* label, int numDatas, const char** names, const ImColor* colors, float(*getter)(void* data, int idx), void** datas, int count, float scaleMin, float scaleMax, ImVec2 graphSize) {
    plotMultiEx(ImGuiPlotType_Lines, label, numDatas, names, colors, getter, datas, count, scaleMin, scaleMax, graphSize);
}

void ImGui::plotMultiHistograms(const char* label, int numHists, const char** names, const ImColor* colors, float(*getter)(void* data, int idx), void** datas, int count, float scaleMin, float scaleMax, ImVec2 graphSize) {
