...
namespace ImGui
{
    ...
    IMGUI_API void          plotMultiEx(ImGuiPlotType plotType, const char* label, int numDatas, const char** names, const ImColor* colors, float(*getter)(void* data, int idx), void** datas, int count, float scaleMin, float scaleMax, ImVec2 graphSize);
