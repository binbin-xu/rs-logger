...
namespace ImGui
{
    ...
    IMGUI_API void          plotMultiLines(const char* label, int numDatas, const char** names, const ImColor* colors, float(*getter)(void* data, int idx), void** datas, int count, float scaleMin, float scaleMax, ImVec2 graphSize = ImVec2(0,0));
    IMGUI_API void          plotMultiHistograms(const char* label, int numHists, const char** names, const ImColor* colors, float(*getter)(void* data, int idx), void** datas, int count, float scaleMin, float scaleMax, ImVec2 graphSize);
...
enum ImGuiKey_
{
    ...
    ImGuiKey_A,         // for CTRL+A: select all and WASDRF camera motion
